...
var removeShopButtons = document.getElementsByClassName("delete-item");
console.log(removeShopButtons);
for(var i=0;i<removeShopButtons.length;i++){
        var button=removeShopButtons[i];
